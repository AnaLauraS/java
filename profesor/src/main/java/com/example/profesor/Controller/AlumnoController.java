...
public class AlumnoController {
    ...
    @PutMapping("/{id}/{profeId}")
    public Alumno asignarAlumnoAProfe(@PathVariable Long id,
                                      @PathVariable Long profeId){
        Alumno alumno = alumnoService.buscarPorID(id);
        Profesor profesor = profesorService.buscarPorID(profeId);
